...
## this script will split the training and testing on each tissue type, so we are sure the samples are balanced on each tissue
## the output of this partition can be used to test per-tissue eQTL (or cis- multi-linear model on each tissue)
